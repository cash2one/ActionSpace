...
# noinspection PyUnusedLocal,PyProtectedMember,PyArgumentList
...
class PeriodicTaskForm(forms.ModelForm):
    regtask = TaskChoiceField(label='已注册任务',
                              required=False)
    task = forms.CharField(label='自定义任务', required=False,
                           max_length=200)
...
# noinspection PyUnusedLocal
class PeriodicTaskAdmin(GuardedModelAdmin):
