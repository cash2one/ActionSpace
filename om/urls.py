...
urlpatterns = [
    ...
    url(r'^lock_flow/(?P<flow_id>[0-9]+)/$', views.lock_flow, name='lock_flow'),
    url(r'^unlock_flow/(?P<flow_id>[0-9]+)/$', views.unlock_flow, name='unlock_flow'),
    url(r'^flow_is_locked/(?P<flow_id>[0-9]+)/$', views.flow_is_locked, name='flow_is_locked'),
    url(r'^diy_report_download/$', views.diy_report_download, name='diy_report_download'),
    url(r'^lock_auto_task/(?P<auto_task_id>[0-9]+)/$', views.lock_auto_task, name='lock_auto_task'),
    url(r'^unlock_auto_task/(?P<auto_task_id>[0-9]+)/$', views.unlock_auto_task, name='unlock_auto_task'),
    url(r'^auto_task_is_locked/(?P<auto_task_id>[0-9]+)/$', views.auto_task_is_locked, name='auto_task_is_locked'),
]
